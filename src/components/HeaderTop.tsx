            ...
            <Container maxWidth={"xl"}>
                <Box className="flex flex-col md:flex-row justify-between items-center p-2 border-b border-white">
                    ...
                    <Box className="flex items-center mb-2 md:mb-0">
                        ...
                        <Typography style={{ color: '#0a3d66' }}>+8801xxxxxxxxxx</Typography>
                    </Box>
                    ...
                    <Box className="flex items-center space-x-4">
                        ...
                        <Box className="flex items-center space-x-1">
                            ...
                            <Typography style={{ color: '#0a3d66' }}>Español</Typography>
                            <IconButton onClick={handleLanguageMenuClick}>
                                <ArrowDropDownIcon />
                            </IconButton>
                            <Menu
                        ...
                        {/* Botón vendedor */}
                        <Typography style={{ color: '#0a3d66' }}>Conviértete en un vendedor</Typography>
                    </Box>
                </Box>
            </Container>
        </Box>
