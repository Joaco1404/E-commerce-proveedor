...
const Navbar: React.FC =() => {
    ...
    return (
        <Box className="bg-white">
            ...
            {/*Seccion izquierdo - Menu despegable de categorias*/}
            <Box className="flex items-center bg-blue 700 p-2 w-full md:w-auto">
                ...
                {/*Seleccion de menu despegable de categorias*/}
            ...
            {/*Seccion medio - Navegacion de enlaces*/}
